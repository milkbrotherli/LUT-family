            ...
            for j in range(len(files_ori)):
                ...
                for frame in range(opt.validPerSize):
                    if frame % opt.validSkipSize == 0:
                        ...
                        # cc_u_alf always integrates its second argument. For
                        # V training, V is therefore passed as the target input.
